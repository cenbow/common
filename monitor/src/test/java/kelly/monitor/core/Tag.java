...
public class Tag implements Comparable<Tag> {
    ...
    private static final ConcurrentHashMap<String, Tag> tagCache = new ConcurrentHashMap<String, Tag>();
    ...
    public boolean equals(Object o) {
        ...
        Tag tag = (Tag) o;
        return Objects.equal(this.key, tag.key) &&
                Objects.equal(this.value, tag.value);
    }
